...
#define INVALID_POINT_VALIDATOR_ERR                                                                                             \
    ERR_MSG_START "Одна из составляющих координаты добавляемой точки (x или y) " \
...
#define INVALID_TRIANGLE_VALIDATOR_ERR                                                                                          \
    ERR_MSG_START "Одна из составляющих координаты добавляемой точки (x или y) " \
...
#define NO_NEEDED_CIRCLES_FOUND                                                                                                                              \
    ERR_MSG_START "Не найдено ни одной окружности, построенной хотя бы на трех данных точках, " \
...
#define INVALID_EDIT_VALIDATOR_ERR                                                                                            \
    ERR_MSG_START "Одна из составляющих координаты изменяемой точки (x или y) " \
                  "не может быть переведена в вещественный тип."
...
// Result Part
#define RESULT_START                                                                                                                            \
    DEFAULT_STRING_START "Угол между осью Оу и прямой, проходящей через центр окружности, " \
